...
public class hspda extends FunctionBase {
    ...
    public static void xnoteadd(final Context context, final ByteString str) {
        ...
        /*
         * } catch (ArrayIndexOutOfBoundsException e) { setElementAtEx(sortget,
         * sameStringIndex, 1); } catch (IndexOutOfBoundsException e) {
         * setElementAtEx(sortget, sameStringIndex, 1);
                }
         */
    }
    ...
    /**
     * 一致する文字列の行インデックス（何行目か）を調べる 線形検索
     *
     * @param bs
     * @return
     */
    ...
    private static ArrayList<Integer> csvFlags = new ArrayList<Integer>();
     ...
     * オプションCCSV_OPT_NOCASE・CCSV_OPT_ZENKAKUおよびCCSV_OPT_EXPRESSIONは ここで反映させること。
